  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-1">
        ...
        {isActive && (
          <span className="shrink-0 text-[9px] sm:text-[10px] font-medium text-primary uppercase tracking-wider mt-0.5">
            active
          </span>
        )}
      </div>
      <div
        className={`text-xl sm:text-2xl font-bold font-mono leading-none ${value}`}
      >
        {carbonIntensity}
