...
export type RouteWorkloadQuery = { routeWorkload: Array<{ rank: number, score: number, reason: string, node: { id: string, name: string, status: NodeStatus, powerDraw: number, zone: ZoneId }, zone: { id: ZoneId, name: string, carbonIntensity: number } }> };
